...
export default function Hero({ onStartSimulation }: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-16 pb-24 md:pt-24 md:pb-32 border-b border-[#F4F2ED]">
      {/* Subtle pearl-tinted background elements */}
      <div className="absolute inset-0 bg-[#F4F2ED]/25 pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            {/* Header / Sub-tag */}
            <span className="inline-flex items-center gap-2 border border-[#0E7C9E]/20 bg-[#F4F2ED] px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest text-[#0E7C9E] font-sans-dm rounded-full shadow-xs">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6.5xl font-medium tracking-tight text-[#12233F] leading-[1.08] font-serif-display">
                Sustained attention guides every Canadian road.
                <span className="block mt-3 text-2xl sm:text-3xl lg:text-4xl text-[#0E7C9E] font-normal tracking-tight font-serif-display">
            ...
            {/* Subheadline */}
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed max-w-xl font-sans-dm font-normal">
            ...
            <div className="pt-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <button
                onClick={() => {
                  /* TODO: route to /simulation */
                  onStartSimulation();
                }}
                className="group inline-flex items-center justify-center gap-3 rounded-lg bg-[#0E7C9E] hover:bg-[#0E7C9E]/90 text-white px-8 py-4.5 text-xs font-black uppercase tracking-widest transition-all duration-200 active:scale-98 cursor-pointer font-sans-dm shadow-lg shadow-[#0E7C9E]/25"
              >
            ...
            {/* Inline Trust Row */}
            <div className="border-t border-[#F4F2ED] pt-6 grid grid-cols-3 gap-4 max-w-xl text-[10px] sm:text-[11px] font-black uppercase tracking-wider text-[#12233F] font-sans-dm">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[#F4F2ED] text-[#0E7C9E] shrink-0 border border-[#0E7C9E]/10">
            ...
            <div className="pt-2 text-[11px] text-slate-500 font-sans-dm flex items-center gap-2">
          ...
          >
            ...
            <div className="w-full max-w-sm mb-6 bg-[#F4F2ED] border border-[#F4F2ED] rounded-2xl p-5 shadow-sm text-left">
              <div className="flex gap-4">
                <Smartphone className="h-5 w-5 text-[#0E7C9E] shrink-0 mt-0.5" />
                <div>
                  <h4 className="text-xs font-bold uppercase tracking-wider text-[#12233F] font-sans-dm">
                    Calibration complete in seconds:
                  </h4>
                  <p className="text-xs text-slate-600 font-sans-dm mt-1.5 leading-relaxed">
            ...
            <div className="relative w-full max-w-[330px] rounded-[48px] border-[12px] border-[#12233F] bg-[#0C1524] p-4.5 shadow-2xl overflow-hidden text-white transition-all duration-300 hover:shadow-[#0E7C9E]/10 hover:border-[#0E7C9E]/30 group">
              ...
              <div className="absolute -top-12 -right-12 w-44 h-44 bg-[#0E7C9E]/10 rounded-full blur-2xl pointer-events-none" />

              {/* Dynamic Camera Notch / RAM Scanning Banner */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-[#12233F] rounded-b-xl flex items-center justify-center gap-2 px-3.5 z-30">
              ...
              <div className="relative z-10 space-y-4 pt-3">
                ...
                <div className="flex justify-between items-center text-[9px] font-mono font-bold text-slate-400 px-1 border-b border-white/5 pb-2">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-[7.5px] bg-[#0E7C9E]/20 text-[#0E7C9E] px-1.5 py-0.5 rounded uppercase font-bold border border-[#0E7C9E]/20">LOCAL</span>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5 text-[9px] font-bold font-mono text-slate-300 uppercase tracking-wider">
                    <Cpu className="h-3.5 w-3.5 text-[#0E7C9E]" />
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-zinc-950/80 border border-white/5 rounded-2xl p-4.5 flex flex-col items-center space-y-3 text-center relative overflow-hidden">
                    ...
                    <div 
                      ...
                      className="relative flex items-center justify-center h-24 w-24 rounded-full bg-[#12233F]/40 border-4 border-[#0E7C9E]/30 shadow-md transition-transform duration-700"
                    >
                      <div className="absolute inset-1 rounded-full border border-dashed border-[#0E7C9E]/10 animate-[spin_60s_linear_infinite]" />
                  ...
                  <div className="bg-zinc-950/80 border border-white/5 rounded-xl p-3.5 space-y-2.5 text-left">
                    <div className="flex justify-between items-center text-[9px] font-mono font-bold text-slate-300">
                      ...
                      <span className="text-[#0E7C9E]">94% STABLE</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <div className="bg-zinc-950/80 border border-white/5 rounded-xl p-3 text-left font-mono">
                      ...
                      <div className="flex items-center gap-1.5 mt-1">
                        ...
                        <span className="text-[10px] font-bold text-[#B8860B]">MINIMAL</span>
                      </div>
                    </div>
                    <div className="bg-zinc-950/80 border border-white/5 rounded-xl p-3 text-left font-mono">
                  ...
                  <div className="bg-zinc-950/80 border border-white/5 rounded-xl p-3 text-left font-mono space-y-1">
                    <div className="flex justify-between items-center border-b border-white/5 pb-1">
                      ...
                      <span className="text-[7px] text-[#0E7C9E] font-bold">LIVE</span>
                    </div>
            ...
            {/* Sub-note */}
            <p className="text-[9px] font-mono text-slate-500 text-center uppercase tracking-widest mt-4 font-bold bg-[#F4F2ED] px-3.5 py-1.5 rounded-full">

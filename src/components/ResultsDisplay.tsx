      ...
      <div className="grid gap-8 md:grid-cols-3 items-stretch mb-12">
        ...
        <div className="rounded-xl border border-slate-900 bg-slate-950 p-6 shadow-md relative flex flex-col justify-between overflow-hidden text-white">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 rounded bg-white py-3 text-xs font-bold uppercase tracking-wider text-slate-900 hover:bg-slate-100 transition-colors cursor-pointer"
            >
              <span>Join Research Cohort</span>
              <ArrowRight className="h-3.5 w-3.5" />
            </button>
            <p className="text-center text-[10px] text-slate-500 font-mono">SPOTS ARE LIMITED IN CA</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border-2 border-[#E6EDF5] bg-white p-6 shadow-xs flex flex-col justify-between">
          ...
          <div className="mt-4 pt-4 border-t border-slate-100 text-center">
            <button
              onClick={onReset}
              className="text-xs font-bold uppercase tracking-wider text-slate-500 hover:text-slate-900 cursor-pointer underline font-mono"
            >
              Restart Study
            </button>
          </div>
